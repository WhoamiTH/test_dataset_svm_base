...
def get_infor_data(infor_method, svm_model_name, train_data, train_label, positive_data, negative_data):
    if infor_method == 'normal':
...
train_method = 'MLP_im_SVMRBF_20000'
num_epochs = 5000
batch_size = 100
start_epochs = 0
# ----------------------------------set parameters---------------------------------------
...
model_type, infor_method, svm_name, num_epochs = train_method.split('_')
num_epochs = int(num_epochs)
svm_model_name = './test_{0}/model_{1}/record_{2}/{1}_{3}.m'.format(dataset_name, svm_name, record_index, dataset_index)
...
informative_minority_data, border_majority_data = get_infor_data(infor_method, svm_model_name, base_train_data, base_train_label, positive_data, negative_data)
...
for train_epoch in dependency_list:
    history_train_method = 'MLP_{0}_{1}_{2}'.format(infor_method, svm_name, train_epoch)
